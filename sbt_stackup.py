# ==============================================================================
# SBT Substrate Stackup 參數化幾何建立腳本
...
#   3. 最後：所有 body 套用 Share Topology
#
...
def create_sbt_stackup(stackup):
    ...
    for i, layer in enumerate(stackup):
        ...
        if i == 0:
            ...
            # 建立 Component
            component = part.Components.Create(name)
    ...
    try:
        share_result = ShareTopology.Create(
            Selection.Create(all_bodies)
        )
